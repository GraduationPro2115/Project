                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-default">
                                <div class="card-header">
                                    <h3 class="card-title"> <?php echo $this->lang->line("Add"); ?></h3>
                                </div><!-- /.box-header -->
                                <!-- form start -->
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="cat_title" class="form-control" placeholder="<?php echo $this->lang->line("Categories Title :"); ?>" />
                                        </div>
                                        <!--
                                        <div class="form-group">
                                            ...
                                            <select class="text-input form-control" name="parent">
                                                ...
                                                function printRow($d)
                                                {
                                                    ...
                                                    // foreach($data as $d){
                                                ?>
                                                     <option value="<?php echo $d->id; ?>"><?php for ($i = 0; $i < $d->leval; $i++) {
                                                                                                echo "_";
                                                                                            }
                                                                                            echo $d->title; ?></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="cat_descri" class="textarea" placeholder="<?php echo $this->lang->line("Categories Description :"); ?>" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                                    ...
                                    <div class="card-footer">
                                        <input type="submit" class="btn btn-primary" name="addcatg" value="<?php echo $this->lang->line("Add"); ?>" />

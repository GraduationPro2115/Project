<tr>
  ...
  <label for="cb_<?php echo $list->id; ?>"></label>
                        ...
                        <td>
                            <div class="btn-group">
                            <a href="<?php echo site_url("business/appointment_service/".$list->id); ?>" class="btn btn-warning btn-sm"> <?php echo $this->lang->line("View"); ?></a>
                            <a href="<?php echo site_url("business/delete_business_appointment/".$list->id); ?>" onclick="return confirm('Are you sure to delete..?')" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                            </div>
                        </td>
                    </tr>
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#"><?php echo $this->lang->line("Doctor"); ?></a></li>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-lg-3 col-xs-6">
              <!-- small box -->
              <a href="<?php echo site_url("business/business_appointment"); ?>" class="small-box-footer">
            ...
            <div class="col-lg-3 col-xs-6">
              <!-- small box -->
              <a href="<?php echo site_url("admin/listuser/2"); ?>" class="small-box-footer">
            ...
            <!--<div class="col-lg-3 col-xs-6">
              <div class="small-box bg-red">
                <div class="inner">
                  <h3>65</h3>
                  <p> <?php echo $this->lang->line("Unique Visitors"); ?></p>
                </div>
                <div class="icon">
              ...
              <form action="" method="post" enctype="multipart/form-data">
                <div class="card card-info">
                  <div class="card-header">
                    ...
                    <h3 class="card-title"> <?php echo $this->lang->line("Quick Notification"); ?></h3>
                    <!-- tools box -->

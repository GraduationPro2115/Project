                ...
                <div class="card card-default">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group">
                          ...
                          <input type="text" name="doct_name" id="doct_name" value="<?php echo $doctor->doct_name; ?>" class="form-control input-sm" required="" placeholder="<?php echo $this->lang->line("Doctor Name"); ?>" data-toggle="floatLabel" data-value="no-js" />
                        </div>
                      </div>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                          <label for="doct_phone"><?php echo $this->lang->line("Doctor Phone"); ?></label>
                          <input type="text" name="doct_phone" id="doct_phone" value="<?php echo $doctor->doct_phone; ?>" class="form-control input-sm" required="" placeholder="<?php echo $this->lang->line("Doctor Phone"); ?>" data-toggle="floatLabel" data-value="no-js" />
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                          ...
                          <input type="text" name="doct_degree" id="doct_degree" value="<?php echo $doctor->doct_degree; ?>" class="form-control input-sm" required="" placeholder="<?php echo $this->lang->line("Doctor Degree"); ?>" data-toggle="floatLabel" data-value="no-js" />
                        </div>
                      </div>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                          <label for="doct_speciality"><?php echo $this->lang->line("Doctor Speciality"); ?></label>
                          <input type="text" name="doct_speciality" id="doct_speciality" value="<?php echo $doctor->doct_speciality; ?>" class="form-control input-sm" required="" placeholder="<?php echo $this->lang->line("Doctor Speciality"); ?>" data-toggle="floatLabel" data-value="no-js" />
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                          ...
                          <input type="email" name="doct_email" id="doct_email" readonly="" value="<?php echo $user->user_email; ?>" class="form-control input-sm" required="" placeholder="<?php echo $this->lang->line("Doctor"); ?> <?php echo $this->lang->line("Email"); ?>" data-toggle="floatLabel" data-value="no-js" />
                        </div>
                      </div>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                          <label for="doct_password"><?php echo $this->lang->line("Doctor"); ?> <?php echo $this->lang->line("Password"); ?></label>
                          <input type="password" name="doct_password" id="doct_password" value="<?php echo _decrypt_val($user->user_password); ?>" class="form-control input-sm" required="" placeholder="<?php echo $this->lang->line("Doctor"); ?> <?php echo $this->lang->line("Password"); ?>" data-toggle="floatLabel" data-value="no-js" />
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-sm-3">
                        <div class="bus-product thumbnail">
                          ...
                          if ($doctor->doct_photo != "") {
                            $proicon = base_url('uploads/business/' . $doctor->doct_photo);
                          }
                          ?>
                    ...
                    <div class="form-group">
                      ...
                      <textarea id="editor1" class="form-control" name="doct_about" placeholder="<?php echo $this->lang->line("Doctor Details :"); ?>" style="height:100px ;"> <?php echo $doctor->doct_about; ?> </textarea>
                    </div>

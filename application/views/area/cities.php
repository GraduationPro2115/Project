                ...
                <form role="form" action="" method="post">
                  <div class="">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="city_name" name="city_name" placeholder="<?php echo $this->lang->line("City Name"); ?>" />
                    </div>
                    <div class="form-group">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?php echo $city->city_lat . "," . $city->city_lon; ?></td>
                        <td><input class='tgl tgl-ios tgl_checkbox' data-table="area_city" data-status="status" data-idfield="city_id" data-id="<?php echo $city->city_id; ?>" id='cb_<?php echo $city->city_id; ?>' type='checkbox' <?php echo ($city->status == 1) ? "checked" : ""; ?> />
                          <label class='tgl-btn' for='cb_<?php echo $city->city_id; ?>'></label>
                        </td>
                        <td>
                          <div class="btn-group">
                          <a href="<?php echo site_url("admin/city_edit/" . $city->city_id); ?>" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>
                          <a href="<?php echo site_url("admin/city_delete/" . $city->city_id); ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                          </div>
                        </td>
                      </tr>
                    <?php

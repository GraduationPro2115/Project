            ...
            <?php if(isset($error)){ echo $error; } ?>
                    <div class="row">    
                        <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-12  col-sm-12">                    
                            <div class="panel panel-info" >
                                    <div class="panel-heading">
                                        <div class="panel-title"><?php echo $this->lang->line("Email Confirmation"); ?></div>
                                    </div>     
                        ...
                        if(isset($success)){
                            ...
                            <a href="<?php site_url("login"); ?>" class="button btn btn-success"><?php echo $this->lang->line("Login Now"); ?></a>
                            <?
                        }
                        ?>    
